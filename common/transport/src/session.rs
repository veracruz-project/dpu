...
impl Session {
    ...
    pub fn from_url(responder_url: &str) -> Result<SessionId> {
        // TODO WIP: Return session ID if session already exists
    ...
    pub fn from_socket(socket: TcpStream) -> Result<SessionId> {
        ...
        // Remove PARSEC key to avoid `PSA_ERROR_ALREADY_EXISTS` error
        ...
        client.psa_destroy_key("parsec-se-driver-key48879")?;
